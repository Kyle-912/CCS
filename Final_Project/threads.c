    ...
    while (1)
    {
        if (playing)
        {
            for (int col = 0; col < 8; col++)
            {
                ...
                ST7789_DrawLine((col * cell_width) + 1, 0, (col * cell_width) + 1, Y_MAX - 1, ST7789_GREEN);                     // Left vertical line
                ST7789_DrawLine(((col + 1) * cell_width - 1) + 1, 0, ((col + 1) * cell_width - 1) + 1, Y_MAX - 1, ST7789_GREEN); // Right vertical line
